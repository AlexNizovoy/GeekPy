...
calc = Calc()
a, b = 15, 5
print("{a} + {b}  {result}".format(calc.sum(a, b)))
print("last_result = {result}".format(calc.last_result))
print("{a} - {b}  {result}".format(calc.sub(a, b)))
print("{a} * {b}  {result}".format(calc.mul(a, b)))
print("last_result = {result}".format(calc.last_result))
print("{a} / {b}  {result}".format(calc.div(a, b)))
print("{a} / 0 = {result}".format(calc.div(a, 0)))
print("last_result = {result}".format(calc.last_result))
