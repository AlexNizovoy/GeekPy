...
1. Налаштування:
	...
	EXPORT_ONLY	- установіть в True, щоб зберігти попередньо отримані дані
	CONTINUE_PREVIOUS - установіть в True, щоб продовжити з перерваної позиції,
			інакше - почне з початкової сторінки
